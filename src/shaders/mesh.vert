...
layout(binding=0) readonly buffer DrawsCommands{
...
void main(){
    ...
    gl_Position = globals.projection * vec4(rotateQuat(position, meshDraw.orientation) * vec3(meshDraw.scale) + meshDraw.position.xyz, 1);
